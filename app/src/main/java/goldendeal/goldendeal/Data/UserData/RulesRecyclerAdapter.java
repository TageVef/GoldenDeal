...
public class RulesRecyclerAdapter extends RecyclerView.Adapter<RulesRecyclerAdapter.ViewHolder> {
    ...
    public RulesRecyclerAdapter(List<String> rulesList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new RulesRecyclerAdapter.ViewHolder(view);
    }
    ...
    @Override
    public int getItemCount() {return rulesList.size();}
